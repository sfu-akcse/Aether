...
# 21 Nodes to identify key parts of the hand
HAND_CONNECTIONS = [
    (0, 1), (1, 2), (2, 3), (3, 4),
    (0, 5), (5, 6), (6, 7), (7, 8),
...
# Configures the camera source to be internal webcam, external connection, or url sourced 
...
# Uses cv2 library to oepn camera capture
...
class LatestFrameReader:
    ...
    # Creates a separate thread to extract camera values?
    def start(self):
        self._running = True
        self._thread.start()
