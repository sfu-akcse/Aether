...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2_ws/install/random_xyz_stream"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/random_xyz_stream/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/random_xyz_stream/environment/path.sh"
