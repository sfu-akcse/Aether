...
: ${AMENT_CURRENT_PREFIX:="/workspace/Aether-firmware_ws/install/hand_xyz_subscriber_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hand_xyz_subscriber_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hand_xyz_subscriber_pkg/environment/path.sh"
